...
public class CartLabActivity extends AppCompatActivity {
    ...
    private Button dateButton , timeButton , btnCheckout , btnBackCart;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      tv = findViewById(R.id.textViewCostCartActivity);
      lst = findViewById(R.id.listViewCartMultiline);
      ...
      //  Toast.makeText(this, "" + dbData, Toast.LENGTH_LONG).show();
        ...
        btnCheckout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("price" , tv.getText());
